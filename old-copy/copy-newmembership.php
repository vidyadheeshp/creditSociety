...
if (isset($_POST['submit'])) {
  ...
  if (empty($error)) {
    ...
    header("location: NewMembershipPDF.php");
  }
}
...
?>
<h3 class="fw-bold text-center  text-wrap mt-4">New Membership Form</h3>
<center>
  <div class="newmember">
    <form class="login-page w-75" method="post" action="#">
      <p style="text-align:justify; color:navy">Fill the following details required for generating the new membership application.
      ...
      <div class="row g-3 my-2">
        ...
        <div class="col align-content-start mx-0 col-lg-10">
      ...
      <div class="row g-3 my-2">
        ...
        <div class="input-group has-validation">
          <input type="text" id="mname" name="mname" value="<?php echo $mname; ?>" style=" text-transform: uppercase" class="form-control <?php if (isset($error['mname'])) echo 'is-invalid'; ?>" pattern="[A-z\s.'-]{1,}" title="Only Alphabets and spaces allowed. Enter your middle name." placeholder="Middle Name" required>
      ...
      <div id="check">
        <div class="row g-3 my-2 ">
          ...
          <div class="input-group has-validation">
            <Select class="form-select <?php if (isset($error['dept'])) echo 'is-invalid'; ?>" id="deptid" required name="deptid" required>
        ...
        <div class="row g-3 my-2">
          ...
          <div class="input-group has-validation">
            <select class="form-select <?php if (isset($error['startdate'])) echo 'is-invalid'; ?>" name="startdate" size='1'>
              <?php
              $selected = "";
              for ($i =  1; $i <  4; $i++) {
                $time = strtotime(sprintf('%d months', $i));
          ...
          <div class="col-12 my-2">
            <button class="btn btn-sm w-50 btn-primary my-3" id="submit" name="submit" value="submit" type="submit">Generate Application</button>
          </div>
        </div>
    </form>
  </div>
...
<div class="register-box">
  <div class="register-logo">
    <a href="index.php"><b>GIT</b>Credit Society</a>
  </div>
  ...
  <div class="register-box-body">
    ...
    <div id="check">
      ...
      <label for="Department" class="form-label fw-bold">Department</label>
          <div class="input-group has-validation">
            <Select class="form-control form-select <?php if (isset($error['dept'])) echo 'is-invalid'; ?>" id="deptid" required name="deptid" required>
              <?php echo $DepartmentList; ?>
            </Select>
            <div class="<?php if (isset($error['dept'])) echo 'invalid-feedback'; ?>">
              <?php if (isset($error['dept'])) echo $error['dept']; ?>
      ...
      <div class="form-group has-feedback">
        <label for="startmonth" class="form-label fw-bold">Start Month</label>
            <div class="input-group has-validation">
              <select class="form-control form-select <?php if (isset($error['startdate'])) echo 'is-invalid'; ?>" name="startdate" size='1'>
                <?php
                $selected = "";
                for ($i =  1; $i <  4; $i++) {
                  $time = strtotime(sprintf('%d months', $i));
